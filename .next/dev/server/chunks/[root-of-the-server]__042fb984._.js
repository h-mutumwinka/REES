...
"[project]/Music/RuralEducation/app/api/teacher/dashboard/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const user = database.prepare("SELECT name FROM users WHERE id = ? AND role = ?").get(userId, "teacher");
        if (!user) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Music$2f$RuralEducation$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__042fb984._.js.map